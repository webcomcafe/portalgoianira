...
class MediaLibraryItem
{
    ...
    public function getFileType()
    {
        ...
        if (!self::$imageExtensions) {
            self::$imageExtensions = array_map('strtolower', Config::get('media.image_extensions', FileDefinitions::get('imageExtensions')));
            self::$videoExtensions = array_map('strtolower', Config::get('media.video_extensions', FileDefinitions::get('videoExtensions')));
            self::$audioExtensions = array_map('strtolower', Config::get('media.audio_extensions', FileDefinitions::get('audioExtensions')));
        }
