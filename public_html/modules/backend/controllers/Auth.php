...
class Auth extends Controller
{
     ...
     */
    protected $publicActions = ['index', 'signin', 'signout', 'restore', 'reset', 'migrate', 'setup'];
    ...
    /**
     * signin_onSubmit handles the submission of the sign in form
     */
    ...
    /**
     * restore_onSubmit submits the restore form
     */
    ...
    /**
     * reset_onSubmit submits the reset form
     */
    ...
    /**
     * setup_onSubmit creates a new admin
     */
    public function setup_onSubmit()
    {
        if (!$this->checkAdminAccounts()) {
            return Backend::redirect('backend/auth/signin');
        }
